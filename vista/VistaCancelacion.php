...
$obj1 = new DetalleRequerimientos($Codigo, '', '', '', '', '', '');
...
<html>
    <head>
        ...
        <title>Cancelación de Requerimientos</title>
    </head>
                ...
                <form class="form-signin" action="../control/ControlAtencionRequerimientos.php" method="post" name="form">
                    <div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="txtidreq" id="codigo" class='form-control' maxlength="20" value="<?php echo'' . $obj1->getIdDetalle(); ?>">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <label>Ingrese la razón de la Cancelación</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <label>Asignar Estado de Solución del Requerimiento</label>
                             <input type="hidden" name="txtestadoant" id="codigo" class='form-control' maxlength="20" value="<?php echo'' . $obj1->getFkEstado(); ?>" readonly>
                        ...
                        <center>
                            <input type="submit" name="accion" class="rainbow-button"  style="font-family:'Britannic'; color: red" value="Cancelar" id="enviar" style="text-align: center;">
                        </center>
                    </div>
                </form>
            </div>
